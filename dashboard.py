...
<body><header class="top"><div class="mark"></div><div class="brand"><h1>Project Tracker</h1><p>Live progress from Discord</p></div><nav class="nav"><a href="#overview">Overview</a><a href="#tree-section">Tech tree</a><a href="#projects-section">Projects</a><a href="#tools">Planner help</a><a href="#reports">Reports</a></nav></header><main>
...
<section id="tree-section"><div class="eyebrow">Roadmap</div><h2>Tech tree</h2><p class="sub">Each connection is a prerequisite. Complete work opens the next path.</p><div class="toolbar"><select id="tree" aria-label="Choose a tech tree"></select></div><p class="tree-note">On a phone, swipe the roadmap sideways to follow every path.</p><div class="tree-wrap"><div id="graph" class="graph"></div></div></section>
