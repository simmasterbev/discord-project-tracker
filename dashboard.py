...
#overview{position:relative;padding-right:150px}.bev{position:absolute;right:10px;top:-12px;width:128px;height:139px;background:url('/assets/prophet-bev-bubble-monkey.webp') 0 0/800% 1100% no-repeat;animation:bev-idle 1.6s steps(8) infinite;filter:drop-shadow(0 10px 14px #0008);pointer-events:none}@keyframes bev-idle{to{background-position:-800% 0}}@media(max-width:780px){#overview{padding-right:96px}.bev{width:86px;height:94px;right:0;top:0}}
</style>
